% PHORCYS data analysis, 7/23/13 by JRC
% modified 9/4/14, 10/16/15 JRC
% mods subsequent to 10/16/15 recorded on GitHub
...
% set constants for salinity compensation, see Aanderaa manual p. 32
...
% -------------------------------------------------------------------------
% load PHORCYS data from model "A" instrument
% -------------------------------------------------------------------------
...
% timepoint into a single line, while retaining the "file opening"
% messages **
% -------------------------------------------------------------------------
